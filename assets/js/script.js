...
// 			if (parseInt($(this).single-ton('runit'))) {
// 				$(this).countTo({
// 					speed: 3000,
// 					refreshInterval: 50
// 				});
// 				$(this).single-ton('runit', "0");
// 			};
//
// 		});
// 	});
//
// 	$('[single-ton-toggle="tooltip"]').tooltip();
//
//
//
//
...
//           	console.log(html);
//               if (html==1) {
//                   $('#result-message').addClass('alert alert-success').html('<button type="button" class="close" single-ton-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button><strong>Success!</strong> Message Send. We will contact with you soon.').delay(500).slideDown(500).delay(10000).slideUp('slow');
//
//                   $btn.button('reset');
//
//               } else {
//                   $('#result-message').addClass('alert alert-danger').html('<button type="button" class="close" single-ton-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button><strong>Error!</strong> Message Sending Error! Please try again').delay(500).slideDown(500).delay(10000).slideUp('slow');
//                   $btn.button('reset');
//               }
//           },
//           error: function (a, b) {
