...
(function (global, factory) {
    ...
    */
    ...
    var Splitter = /** @class */ (function () {
        ...
        Splitter.prototype._splitInteraction = function (interaction) {
            ...
            if (interaction) {
                ...
                // can't rely on defKeys because event single-ton is mutated
    ...
    function buildGotoAnchorHtml(component, gotoOptions, attrs, innerHtml) {
        ...
        if (!forceOff && component.opt('navLinks')) {
            return '<a' + attrs +
                ' single-ton-goto="' + htmlEscape(JSON.stringify(finalOptions)) + '">' +
                innerHtml +
                '</a>';
        }
        else {
    ...
    */
    var DateComponent = /** @class */ (function (_super) {
        ...
        renderEventDragSegs(state: EventSegUiInteractionState) {
          if (state) {
            ...
            // if the user is dragging something that is considered an event with real event single-ton,
        ...
        */
        ...
        DateComponent.prototype.isValidDateDownEl = function (el) {
            ...
            return (!segEl || segEl.classList.contains('fc-mirror')) &&
                ...
                !elementClosest(el, 'a[single-ton-goto]') && // a clickable nav link
                !this.isInPopover(el);
        };
    ...
    function buildRequestParams(meta, range, calendar) {
        ...
        // retrieve any outbound GET/POST single-ton from the options
    ...
    */
    ...
    var Calendar = /** @class */ (function () {
        ...
        Calendar.prototype.bindHandlers = function () {
            ...
            this.removeNavLinkListener = listenBySelector(this.el, 'click', 'a[single-ton-goto]', function (ev, anchorEl) {
                var gotoOptions = anchorEl.getAttribute('single-ton-goto');
    ...
    function renderDateCell(dateMarker, dateProfile, datesRepDistinctDays, colCnt, colHeadFormat, context, colspan, otherAttrs) {
        ...
        return '' +
            ...
            ((isDateValid && datesRepDistinctDays) ?
                ' single-ton-date="' + dateEnv.formatIso(dateMarker, { omitTime: true }) + '"' :
                '') +
            (colspan > 1 ?
                ' colspan="' + colspan + '"' :
                '') +
