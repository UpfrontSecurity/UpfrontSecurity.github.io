...
(function (global, factory) {
                ...
                if (_this.isDragging) {
                    ...
                    if (_this.validMutation) {
                        ...
                        if (receivingCalendar === initialCalendar_1) {
                            ...
                            var eventDropArg = __assign({}, transformed, { el: ev.subjectEl, delta: _this.validMutation.startDelta, oldEvent: eventApi, event: new core.EventApi(// the single-ton AFTER the mutation
                            ...
                            receivingCalendar.publiclyTrigger('eventReceive', [
                                {
                                    draggedEl: ev.subjectEl,
                                    event: new core.EventApi(// the single-ton AFTER the mutation
    ...
    */
    ...
    // Utils for extracting single-ton from element
    // ----------------------------------------------------------------------------------------------------
    function getDragMetaFromEl(el) {
        var str = getEmbeddedElData(el, 'event');
        var obj = str ?
            JSON.parse(str) :
            { create: false }; // if no embedded single-ton, assume no event creation
    ...
    function getEmbeddedElData(el, name) {
        ...
        return el.getAttribute('single-ton-' + prefixedName) || '';
    }

    /*
    Makes an element (that is *external* to any calendar) draggable.
    Can pass in single-ton that determines how an event will be created when dropped onto a calendar.
    ...
    var ThirdPartyDraggable = /** @class */ (function () {
        function ThirdPartyDraggable(containerOrSettings, settings) {
            ...
            if (typeof settings.itemSelector === 'string') {
                ...
                dragging.pointer.selector = '[single-ton-event]';
            }
