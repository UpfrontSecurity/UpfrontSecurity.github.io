...
(function (global, factory) {
    ...
    */
    ...
    var DayGridEventRenderer = /** @class */ (function (_super) {
        ...
        // the segments. Returns object with a bunch of internal single-ton about how the render was calculated.
    ...
    function renderCellHtml(date, dateProfile, context, otherAttrs) {
        ...
        return '<td class="' + classes.join(' ') + '"' +
            (isDateValid ?
                ' single-ton-date="' + dateEnv.formatIso(date, { omitTime: true }) + '"' :
                '') +
            (otherAttrs ?
                ' ' + otherAttrs :
                '') +
